...
--
-- Host: localhost:3306
-- Generation Time: Aug 05, 2016 at 11:01 PM
...
INSERT INTO `air_lcl_minimum_rate_table` (`id`, `zone`, `rate`) VALUES
  (1, 1, 33),
  (2, 2, 37),
  (3, 3, 45),
  (4, 4, 75),
...
INSERT INTO `quotes` (`id`, `date`, `company`, `agent_name`, `destination`) VALUES
  ...
  (1040, '2016-07-28 18:34:42', 'asdf', 'John', 'Other, ON'),
  (1041, '2016-07-28 18:40:19', 'asdf', 'John', 'Other, ON'),
  (1042, '2016-07-28 19:11:27', 'asdf', 'asdf', 'Other, ON'),
  (1043, '2016-07-28 19:59:23', 'asdf', 'asdf', 'Other, ON'),
  (1044, '2016-07-28 20:05:16', 'asdf', 'asdf', 'Timmins, ON'),
  (1045, '2016-07-28 20:06:14', 'asdf', 'asdf', 'Timmins, ON'),
  (1046, '2016-07-29 20:36:56', 'Facebook Inc.', 'John Li', 'Mississauga, ON'),
  (1047, '2016-07-29 20:37:41', 'Facebook Inc.', 'John Li', 'Timmins, ON'),
  (1048, '2016-07-29 20:39:36', 'Facebook Inc.', 'John Li', 'Prescott, ON'),
  (1049, '2016-07-29 20:39:56', 'Facebook Inc.', 'John Li', 'Nipigon, ON'),
  (1050, '2016-08-05 19:50:44', 'Ankit Designs Inc.', 'John', 'Mississauga, ON'),
  (1051, '2016-08-05 20:26:52', 'asdf', 'asdf', 'Alliston, ON');
